...
<div class="w-100 p-4 d-flex justify-content-center">
  <form action="{{ route('users.update', ['user' => $user->id]) }}" method="POST" class="w-50">
    ...
    <div class="d-flex justify-content-between">
      ...
      <div class="w-100 input-field">
        <input id="input_text" type="text" id="name" name="name" value="{{ old('name', $user->name) }}" autofocus>
      ...
      <div class="w-100 input-field">
        <input id="input_text" type="email" id="email" name="email" value="{{ old('email', $user->email) }}">
    ...
    <div class="d-flex justify-content-between">
      ...
      <div class="w-100 input-field">
        <input id="input_text" type="text" id="username" name="username" value="{{ old('username', $user->username) }}">
      ...
      <div class="w-100 input-field">
        {!! Form::select('roles[]', $roles, $userRole,['class'], array('class' => '')) !!}
      </div>
