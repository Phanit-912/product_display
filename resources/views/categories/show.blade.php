...
<div class="w-100">
  ...
  <div class="w-100 d-flex justify-content-between  align-items-center border-bottom">
    ...
    <div class="w-100 text-center">
      <h4 class="text-truncate mx-0 my-3">Category Detail</h4>
    </div>
...
<div class="w-25 m-auto p-4 border border-danger rounded">
  <div class="w-100 d-flex justify-content-between">
    <div class="w-100">
      ...
      <h5 class="m-0 p-0">{{ $category->category_name }}</h5>  
    </div>  
    ...
    <div class="w-100">
      ...
      <h5 class="m-0 p-0">{{ $category->category_code }}</h5>  
    </div>  
  </div>
  <div class="w-100 py-4">
    <p class="m-0 p-0">Brand Note</p>
    <h5 class="m-0 p-0">{{ $category->category_note }}</h5>
  </div>

  <div class="w-100 d-flex justify-content-between">
    <div class="w-100">
      <p class="m-0 p-0">Created by</p>
      <p class="m-0 p-0 fs-5">{{ $category->created_by_name }}</p>  
    </div>  
    ...
    <div class="w-100">
      ...
      <p class="m-0 p-0 fs-5">{{ $category->created_at }}</p>  
    </div>  
  </div>
</div>
